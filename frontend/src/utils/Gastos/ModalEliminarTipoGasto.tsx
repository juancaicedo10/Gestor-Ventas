...
const ModalDeleteTipoGasto: React.FC<ModalProps> = ({ isOpen, onClose, Id, getTipoGastos}) => {

  const handleDelete = () => {
    try {
      axios
        .delete(
          `https://backendgestorventas1.azurewebsites.net/api/gastos/tipo/${Id}`,
          {
            headers: {
        ...
        .then(() => {
          console.log("Tipo Gasto ELIMINADO EXITOSAMENTE");
          getTipoGastos();
          onClose();
        })
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                       ¿Estas Seguro que quieres Eliminar este Tipo de gasto?
                      </p>
                    </div>
                  </div>
                </div>
...
export default ModalDeleteTipoGasto;
