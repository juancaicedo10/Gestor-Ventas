...
const AdminDeleteModal: React.FC<ModalProps> = ({ isOpen, onClose, Id, getAdministradores}) => {

  const handleDelete = () => {
    try {
      axios
        .delete(
          `https://backend-gestor-ventas.onrender.com/api/administradores/${Id}`,
          {
            headers: {
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                       ¿Estas Seguro que quieres Eliminar este Adminstrador?
                      </p>
                    </div>
                  </div>
                </div>
