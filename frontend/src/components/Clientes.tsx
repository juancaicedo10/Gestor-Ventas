...
function Clientes() {
  ...
  return (
    ...
    <Sidebar />   
    <div className='flex flex-col justify-center text-3xl font-bold w-full'>
    <section className='flex mx-2 justify-between'>
    <h1 className='my-2 text-2xl text-start'>Vendedores</h1>
      ...
      <section className='w-full'>
        <ul className='w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 place-items-start rounded-md'>
            {clients.map((client, Id) => (
                            <li className='w-11/12 min-h-[260px] rounded-md flex flex-col bg-white border-2 border-black' key={Id}>
