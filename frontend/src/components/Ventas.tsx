...
function Ventas() {
  ...
  const estados = ['Pagado', 'Pendiente', 'Pendiente', 'Pendiente', 'Pendiente'];
      ...
      <section className="grid grid-cols-4 gap-4">
        <div className='flex flex-col items-center'>
          ...
          <ul className='list-none'>
            {cuotas.map((cuota, index) => <li key={index}>{cuota}</li>)}
          </ul>
        </div>
        <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <ul className='list-none'>
            {intereses.map((interes, index) => <li key={index}>{interes}</li>)}
          </ul>
        </div>
        <div className='flex flex-col items-center'>
          <h1 className='text-xl text-center'>Fecha</h1>
          <ul className='list-none'>
            {fechas.map((fecha, index) => <li key={index}>{fecha}</li>)}
          </ul>
        </div>
      </section>
