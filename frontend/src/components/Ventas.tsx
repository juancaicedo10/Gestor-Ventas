            ...
            <li>
              <div className="flex flex-col m-2 p-2">
                ...
                <SellIcon fontSize="small"/>
                      <span className="font-semibold text-blue-900">Numero Venta:</span>{" "}
                      {'000001'}
                    </li>
                    <li className="p-1">
                      <SellIcon fontSize="small"/>
                    ...
                    <li className="p-1">
                    <SellIcon fontSize="small"/>
                      <span className="font-semibold text-blue-900">Periodicidad</span>:{" "}
                      {venta.Periodicidad}
                    </li>
                    <li className="p-1 text-blue-800">
                    <SellIcon fontSize="small"/>
                      <span className="font-semibold ">Fecha Inicio:</span>{" "}
                      {new Date(venta.FechaInicio).toLocaleDateString('es-ES')}
                    </li>
                ...
                <ul className="grid grid-cols-2 rounded-md border-2 p-2 w-full py-2 bg-white">
                <li>
                ...
                <h6 className="font-bold text-xl">Ir a detalles de cuotas:</h6>
                <Link to='/' className="text-blue-800">Cuotas Detalles</Link>
                </div>
              </div>
            </li>
          ))}
